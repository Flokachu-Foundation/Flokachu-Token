...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minPeriod = 3 hours; // min 1 hour delay
    uint256 public minDistribution = 25 * (10 ** 16); // 0.25 DOT minimum auto send
    uint256 public minimumTokenBalanceForDividends = 100000000 * (10**9); // user must hold 100,000,000 token
...
contract FLOKACHU is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    string constant _name = "FLOKACHU TOKEN";
    string constant _symbol = "FLOKACHU";
